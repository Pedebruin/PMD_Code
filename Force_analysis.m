% Constants
r = 150         % milimeters waferRadius
h = 120         % milimeters waferRadius*cos(flatAngle)
L_12 = 100      % milimeters d_pins!

% Variables
theta = deg2rad(0)          % degrees Angle of Pin1
phi = deg2rad(45)           % degrees Angle of nesting force
F_n = 1.5                   % Newton  Nesting force angle
